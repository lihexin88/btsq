<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\wamp\www\btsq\public/../application/admin\view\publics\login.html";i:1547804558;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
                ...
                <div class="widget-main">
                  ...
                  <form class="form-signin">
                    <fieldset>
                      ...
                      <label class="block clearfix"> <span class="block input-icon input-icon-right">
                        <input name="phone" type="text" class="" placeholder="手机号码" />
                        <a class="btn btn-sm btn-primary" id='get_verification'>发送验证码</a>
                        </span> </label>
                      <label class="block clearfix"> <span class="block input-icon input-icon-right">
                        <input id='code' name="code" type="text" class="form-control" placeholder="手机验证码" />
                        </span> </label>
                      <label class="block clearfix"> <span class="block input-icon input-icon-right">
